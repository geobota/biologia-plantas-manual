...
**Spermatophyta** posee algunas sinapomorfías que le definen, pero su principal carácter evolutivo es el desarrollo de la **semilla**, para lo cual primero debieron ocurrir algunas innovaciones evolutivas como son: **evolución del tegumento**, **endosporia**, **heterosporia**, **reducción de la megaspora a una**, **retención de la megaspora**. Spermatophyta cuentan con más de 300000 especies distribuidas por todo el mundo y agrupadas en un amplio número de linajes.
